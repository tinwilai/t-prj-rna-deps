...
def get_features(fas_fpath, msa_fpath, msa_depth=256):
    ...
    Args:
        fas_fpath (str): Path to the input fasta file.
        msa_fpath (str): Path to the MSA file.
        msa_depth (int): The number of sequences in MSA.
...
def get_features_for_fm(fasta_path):
    """
    Generate the RNA-FM tokens from the input fasta file.
    The fasta file can contain multiple sequences.

    Args:
        fasta_path (str): Path to the input fasta file.

    Returns:
        dict: A dictionary containing the RNA-FM tokens, key is 'rna_fm_tokens'.
    """
